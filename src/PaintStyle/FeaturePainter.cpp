...
//    qreal pathSurface = tranformedRoadPath.controlPointRect().horizontalAdvance() * tranformedRoadPath.controlPointRect().height();
//    if (pathSurface > theRenderer->theScreen.horizontalAdvance() * theRenderer->theScreen.height() * 3) {
